...
public class SplashActivity extends Activity implements OnPageChangeListener
{
  ...
  private void initViews()
  {
    ...
    start_btn.setOnClickListener(new OnClickListener()
    {
      ...
      public void onClick(View arg0)
      {
        ...
        SplashActivity.this.overridePendingTransition(R.anim.activity_move_in_start,
  ...
  /*
   * //在ViewPager上添加页面滑动的导航点，用以表示当前ViewPager的索引 private void initDots() { dots=new
   * ImageView[views.size()]; for(int i=0;i<views.size();i++) {
