...
import cn.common.view.HeadListView.HeaderAdapter;
import cn.common.view.HeadListView.HeaderStatus;

public class CityAdapter extends BaseAdapter
    implements SectionIndexer, HeaderAdapter, OnScrollListener
{
  ...
  public CityAdapter(Context mContext, List<CityEntity> cityList)
  {
  ...
  {
    return cityList.isEmpty() ? null : cityList.get(position);
  }
  ...
  public int getHeaderState(int position)
  {
    ...
    {
      return HeaderStatus.HEADER_GONE;
    }
    int section = getSectionForPosition(realPosition);
    int nextSectionPosition = getPositionForSection(section + 1);
    if (nextSectionPosition != -1 && realPosition == nextSectionPosition - 1)
    {
      return HeaderStatus.HEADER_PUSHED_UP;
    }
    return HeaderStatus.HEADER_VISIBLE;
  }
