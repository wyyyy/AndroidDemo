...
public class ChannelDao implements IChannelDao
{
  ...
  public Map<String, String> viewCache(String selection, String[] selectionArgs)
  {
    ...
    try
    {
      ...
      cursor = database.query(true, SqlHelper.TABLE_CHANNEL, null, selection, selectionArgs, null,
          null, null, null);
  ...
  public List<Map<String, String>> listCache(String selection, String[] selectionArgs)
  {
    ...
    {
      database = helper.getReadableDatabase();
      cursor = database.query(false, SqlHelper.TABLE_CHANNEL, null, selection, selectionArgs, null,
          null, null, null);
      int cols_len = cursor.getColumnCount();
      while (cursor.moveToNext())
      {
