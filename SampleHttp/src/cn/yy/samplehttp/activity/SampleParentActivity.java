...
import cn.commonhelp.http.help.AsyncHttpRequest;
		...
		SampleInterface
{
	...
	{
		menu.add(Menu.NONE, MENU_USE_HTTPS, Menu.NONE, R.string.menu_use_https)
				.setCheckable(true);
		menu.add(Menu.NONE, MENU_CLEAR_VIEW, Menu.NONE,
				R.string.menu_clear_view);
		menu.add(Menu.NONE, MENU_ENABLE_LOGGING, Menu.NONE, "Enable Logging")
				.setCheckable(true);
		menu.add(Menu.NONE, MENU_LOGGING_VERBOSITY, Menu.NONE,
	...
	private void showLoggingVerbosityDialog()
	{
		AlertDialog ad = new AlertDialog.Builder(this)
				...
				{ "VERBOSE", "DEBUG", "INFO", "WARN", "ERROR", "WTF" },
						...
						}).setCancelable(true).setNeutralButton("Cancel", null)
				.create();
		ad.show();
	}
	...
	public void onRunButtonPressed()
	{
		addRequestHandle(executeSample(getAsyncHttpClient(),
				getUrlText(getDefaultURL()), getRequestHeaders(),
				getRequestEntity(), getResponseHandler()));
	}
