...
public class Redirect302Sample extends GetSample
{
	...
	{
		menu.add(Menu.NONE, MENU_ENABLE_REDIRECTS, Menu.NONE,
				"Enable redirects").setCheckable(true);
		menu.add(Menu.NONE, MENU_ENABLE_RELATIVE_REDIRECTs, Menu.NONE,
				"Enable relative redirects").setCheckable(true);
		menu.add(Menu.NONE, MENU_ENABLE_CIRCULAR_REDIRECTS, Menu.NONE,
				"Enable circular redirects").setCheckable(true);
	...
	public boolean onPrepareOptionsMenu(Menu menu)
	{
		...
		MenuItem menuItemEnableRelativeRedirects = menu
				.findItem(MENU_ENABLE_RELATIVE_REDIRECTs);
		if (menuItemEnableRelativeRedirects != null)
			menuItemEnableRelativeRedirects.setChecked(enableRelativeRedirects);
		MenuItem menuItemEnableCircularRedirects = menu
				.findItem(MENU_ENABLE_CIRCULAR_REDIRECTS);
		...
		if (client instanceof DefaultHttpClient)
		{
			Toast.makeText(
					...
					String.format(
							...
							enableRedirects, enableRelativeRedirects,
							enableCircularRedirects), Toast.LENGTH_SHORT)
					.show();
			ahc.setEnableRedirects(enableRedirects, enableRelativeRedirects,
