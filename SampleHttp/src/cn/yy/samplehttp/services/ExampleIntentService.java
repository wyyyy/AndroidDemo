package cn.yy.samplehttp.services;
...
import cn.yy.samplehttp.activity.IntentServiceSample;
					...
					new AsyncHttpResponseHandler()
					{
						...
						public void onStart()
						{
							sendBroadcast(new Intent(
									IntentServiceSample.ACTION_START));
							Log.d(LOG_TAG, "onStart");
						}
								...
								byte[] responseBody)
						{
							Intent broadcast = new Intent(
									IntentServiceSample.ACTION_SUCCESS);
							broadcast.putExtra(INTENT_STATUS_CODE, statusCode);
							broadcast.putExtra(INTENT_HEADERS,
									IntentUtil.serializeHeaders(headers));
						...
						{
							Intent broadcast = new Intent(
									IntentServiceSample.ACTION_FAILURE);
							broadcast.putExtra(INTENT_STATUS_CODE, statusCode);
							broadcast.putExtra(INTENT_HEADERS,
									IntentUtil.serializeHeaders(headers));
							broadcast.putExtra(INTENT_DATA, responseBody);
						...
						{
							sendBroadcast(new Intent(
									IntentServiceSample.ACTION_CANCEL));
						...
						{
							sendBroadcast(new Intent(
									IntentServiceSample.ACTION_RETRY));
							Log.d(LOG_TAG,
									String.format("onRetry: %d", retryNo));
						}
						...
						{
							sendBroadcast(new Intent(
									IntentServiceSample.ACTION_FINISH));
