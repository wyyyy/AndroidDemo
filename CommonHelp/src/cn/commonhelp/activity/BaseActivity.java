package cn.commonhelp.activity;
...
public class BaseActivity extends Activity
{
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		/*if (!(MainCommon.display.widthPixels > 0 && MainCommon.display.heightPixels > 0))
		{
			DisplayMetrics dm = new DisplayMetrics();
			getWindowManager().getDefaultDisplay().getMetrics(dm);
			// 获得手机的宽带和高度像素单位为px
			MainCommon.display.widthPixels = dm.widthPixels;
...
//		}
	...
	protected void onRestoreInstanceState(Bundle savedInstanceState)
	{
		...
		if (savedInstanceState != null)
		{
			...
			// App.nonelongitude);
			// C.display.heightPixels =
			// savedInstanceState.getInt("C.display.heightPixels");
	 ...
	 * @param type
	 *            sendType
	 * @return true：正常 false：不正常 创建时间：2012-9-4 下午5:55:03
	 */
	public boolean checkNetWorkShowLog(final int type)
	{
		...
		{ // ?行?置??
			Builder b = new AlertDialog.Builder(context).setTitle(
					R.string.network_show_title).setMessage(
					R.string.network_show_msg);
			b.setPositiveButton(R.string.network_show_setting,
					...
					.setNeutralButton(R.string.network_show_exit,
							new DialogInterface.OnClickListener()
							{
								@Override
								public void onClick(DialogInterface dialog,
