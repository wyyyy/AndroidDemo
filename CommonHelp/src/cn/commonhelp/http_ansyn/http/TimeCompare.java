...
//	private static final int hour = 1000 * 60;
	 ...
	 * @return 小时数
	 */
	@SuppressLint("SimpleDateFormat") public static int compareHourTime(String start,String end){
	 ...
	 * @return 小时数
	 */
	@SuppressLint("SimpleDateFormat") public static int compareHourTime(String start){
