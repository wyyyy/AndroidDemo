 ...
 * {@link #onSuccess(int, cz.msebera.android.httpclient.Header[], String)}
 ...
 * {@link #onFailure(int, cz.msebera.android.httpclient.Header[], String, Throwable)}
	...
	public static String getResponseString(byte[] stringBytes, String charset)
	{
		...
		} catch (UnsupportedEncodingException e)
		{
			AsyncHttpClient.log.e(LOG_TAG,
					"Encoding response into string failed", e);
			return null;
		}
	}
