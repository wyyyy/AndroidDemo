 ...
 * { &quot;image/png&quot; };
 * client.get(&quot;https://www.example.com/image.png&quot;, new BinaryHttpResponseHandler(
 * 		allowedTypes)
 * {
 * 	&#064;Override
		...
		AsyncHttpResponseHandler
{
	...
	public BinaryHttpResponseHandler(String[] allowedContentTypes)
	{
		...
		} else
		{
			AsyncHttpClient.log.e(LOG_TAG,
					"Constructor passed allowedContentTypes was null !");
		}
	}

	/**
	 * Creates a new BinaryHttpResponseHandler with a user-supplied looper, and
	 * overrides the default allowed content types with passed String array
	 * (hopefully) of content types.
	 * 
	 * @param allowedContentTypes
	 *            content types array, eg. 'image/jpeg' or pattern '.*'
	 * @param looper
			...
			throws IOException
	{
		...
		for (String anAllowedContentType : getAllowedContentTypes())
		{
			...
			{
				AsyncHttpClient.log.e(LOG_TAG, "Given pattern is not valid: "
						+ anAllowedContentType, e);
			}
		}
