...
public class RequestHandle
{
	 ...
	 * this method returned true. Subsequent calls to isDone() will return true
	 * either if the request got cancelled by this method, or if the request
	 * completed normally
	 * 
	...
	public boolean cancel(final boolean mayInterruptIfRunning)
	{
		...
		if (_request != null)
		{
			if (Looper.myLooper() == Looper.getMainLooper())
			{
				...
				// Cannot reliably tell if the request got immediately canceled
				// at this point
