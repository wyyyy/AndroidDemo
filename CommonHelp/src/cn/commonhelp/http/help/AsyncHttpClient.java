...
public class AsyncHttpClient
{
			...
			final PushbackInputStream inputStream) throws IOException
	{
		...
		int streamHeader = (signature[0] & 0xff)
	 ...
	 *            the URL to send the request to.
	 * @param entity
	 *            a raw {@link cz.msebera.android.httpclient.HttpEntity} to send
	 *            with the request, for example, use this to send
	 *            string/json/xml payloads to a server by passing a
	 *            {@link cz.msebera.android.httpclient.entity.StringEntity}.
	 * @param contentType
	...
	// 新增的 有问题
	private HttpUriRequest addEntityToRequestBase(HttpGet httpGet,
			HttpEntity entity)
	{
	...
	// 有问题
	private HttpUriRequest addEntityToRequestBase(HttpDelete httpDelete,
			HttpEntity entity)
	{
		// TODO Auto-generated method stub
		return null;
	...
	private HttpEntityEnclosingRequestBase addEntityToRequestBase(
			HttpEntityEnclosingRequestBase httpGet, HttpEntity entity)
	{
		if (entity != null)
		{
