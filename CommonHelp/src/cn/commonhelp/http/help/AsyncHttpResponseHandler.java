 ...
 * {@link #onSuccess(int, cz.msebera.android.httpclient.Header[], byte[])}
 * method is designed to be anonymously overridden with your own response
 * handling code.
 * <p>
 * &nbsp;
 * </p>
 * Additionally, you can override the
 * {@link #onFailure(int, cz.msebera.android.httpclient.Header[], byte[], Throwable)}
		...
		ResponseHandlerInterface
{
	 ...
	 * @see <a
	 *      href="https://docs.oracle.com/javase/7/docs/api/java/nio/charset/Charset.html">Charset</a>
	 */
	...
	public void onProgress(long bytesWritten, long totalSize)
	{
		AsyncHttpClient.log.v(LOG_TAG, String.format(
				"Progress %d from %d (%2.0f%%)", bytesWritten, totalSize,
	...
	public void onRetry(int retryNo)
	{
		AsyncHttpClient.log.d(LOG_TAG,
				String.format("Request retry no. %d", retryNo));
	}
