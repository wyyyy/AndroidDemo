 ...
 * 
 * String[] colors =
 * { &quot;blue&quot;, &quot;yellow&quot; }; // Ordered collection
 * params.put(&quot;colors&quot;, colors); // url params: &quot;colors[0]=blue&amp;colors[1]=yellow&quot;
 * 
 * File[] files =
 * { new File(&quot;pic.jpg&quot;), new File(&quot;pic1.jpg&quot;) }; // Ordered collection
...
public class RequestParams implements Serializable
{
			...
			String customFileName) throws FileNotFoundException
	{
		...
		if (key != null)
		{
			...
			for (File file : files)
			{
				...
				fileWrappers.add(new FileWrapper(file, contentType,
						customFileName));
			}
	...
	public String toString()
	{
				...
				.entrySet())
		{
			...
			result.append(entry.getKey());
			result.append("=");
			result.append("FILES(SIZE=").append(entry.getValue().size())
					.append(")");
		}
	 ...
	 *         {@link cz.msebera.android.httpclient.client.methods.HttpEntityEnclosingRequestBase}
	 * @throws IOException
