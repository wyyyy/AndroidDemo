...
public class SliderBanner extends RelativeLayout
{
	...
	public SliderBanner(Context context, AttributeSet attrs)
	{
		...
		TypedArray arr = context.obtainStyledAttributes(attrs,
				R.styleable.SliderBanner, 0, 0);
		if (arr != null)
		{
			if (arr.hasValue(R.styleable.SliderBanner_slider_banner_pager))
			{
				mIdForViewPager = arr.getResourceId(
						R.styleable.SliderBanner_slider_banner_pager, 0);
			}
			...
			mTimeInterval = arr.getInt(
					R.styleable.SliderBanner_slider_banner_time_interval,
					mTimeInterval);
			arr.recycle();
		}
	}
	...
	protected void onFinishInflate()
	{
		...
		mViewPager.setOnPageChangeListener(new ViewPager.OnPageChangeListener()
		{
			...
			public void onPageSelected(int position)
			{
				...
				{
					mPagerIndicator.setSelected(mBannerAdapter
