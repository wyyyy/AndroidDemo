...
public class DefaultImageReSizer implements ImageReSizer
{
	...
	public int getInSampleSize(ImageTask imageTask)
	{
		int size = calculateInSampleSize(imageTask.getBitmapOriginSize().x,
				imageTask.getBitmapOriginSize().y,
				imageTask.getRequestSize().x, imageTask.getRequestSize().y);
		return size;
	}
	 ...
	 */
	public static int calculateInSampleSize(int originWidth, int originHeight,
